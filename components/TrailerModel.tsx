...
export default function Model() {
  ...
  const { data, isLoading, error }: Response = useSWR(
    `https://api.themoviedb.org/3/${media}/${id}/videos?api_key=${process.env.NEXT_PUBLIC_DB_key}&language=en-US`,
    fetcher
  );
  const OfficalTrailer =
    !isLoading && !error
