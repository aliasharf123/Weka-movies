            ...
            <div className=" w-full sm:px-10 px-0 flex flex-col gap-2 ">
                {data.results.map(result =>{
                    return(
                        ...
                        {result.poster_path ? <Image width={200} className='w-[140px]  object-cover sm:rounded-l-lg  ml-0'  height={300} src={`https://image.tmdb.org/t/p/w780${result.poster_path}`} alt={result.original_title}  unoptimized/> :  <Image width={200}  className='bg-slate-400 w-[140px]  rounded-l-lg' height={300} src='https://www.themoviedb.org/assets/2/v4/glyphicons/basic/glyphicons-basic-38-picture-grey-c2ebdbb057f2a7614185931650f8cee23fa137b93812ccb132b9df511df1cfac.svg' alt={result.original_title} />}
