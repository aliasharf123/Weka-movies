...
export default function DetaildContentCard({movie} : {movie : ContentItem}) {
    ...
    return (
        <Link href={`/Movies/${movie.id}`}>
            <div className=''>
                {movie.poster_path && <Image className=" rounded-t-xl brightness-[.80] duration-300   object-cover"  src={`https://www.themoviedb.org/t/p/w500${movie.poster_path}`} alt={title as any} width={400} height={200} />}
